...
public:
	...
	bool SaveToFile( IFileSystem *filesystem, const char *resourceName, const char *pathID = NULL, bool b=false );
	//  BOOL __cdecl KeyValues::SaveToFile(class IFileSystem * __ptr64,char const * __ptr64,char const * __ptr64,BOOL) __ptr64
	...
	void RecursiveSaveToFile( CUtlBuffer& buf, int indentLevel, bool unk1, bool unk2 );
...
private:
	byte m_bPadding[0x1C];
};

static_assert(sizeof( KeyValues ) == 0x1C, "KeyValues size wrong");
